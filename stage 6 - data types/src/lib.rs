...
/// reasoning as stages 2-5, carried forward here since each stage is an
/// independent crate.
...
/// happens to read them. Caps concurrent connections at
/// [`MAX_CONNECTIONS`]; see stage 2's `run_with_limit` notes for why a
/// cap exists at all.
